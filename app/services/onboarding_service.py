...
def tiene_datos_capturados(
    ...
    """
    return bool(ingresos.listar(usuario_id) or tarjetas.listar_todas(usuario_id))
...
class OnboardingService:
    ...
    def ejecutar(self, usuario_id: int, datos: OnboardingRequest) -> OnboardingResponse:
        ...
        self.usuarios.actualizar_liquidez(usuario_id, datos.liquidez)
    ...
    def _crear_tarjeta(self, usuario_id: int, tarjeta: TarjetaOnboarding) -> None:
        ...
        self.tarjetas.actualizar_terminos(
            ...
            msi=[m.model_dump() for m in t.msi_vigentes],
        )
